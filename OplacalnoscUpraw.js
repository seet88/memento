...
function UzupelnijKosztDlaWszystkichTabel(){
	var listaStrukturTabel = [
		{Nazwa: "Arch Siew PROD 2017", NazwaCenyZabiegu: "Cena mieszanki (zl/ha)", NazwaZabiegu: "Mieszanina", NumberZabiegu: "Numer mieszanki", Sezon: "2017", Zrodlo: "Siew"},
		{Nazwa: "Arch SoR Mieszaniny PROD 2017", NazwaCenyZabiegu: "Cena mieszanki (zl/ha)", NazwaZabiegu: "Mieszanina", NumberZabiegu: "Numer mieszanki", Sezon: "2017", Zrodlo: "SoR"},
		{Nazwa: "Arch PaPu Nawozenie PROD 2017", NazwaCenyZabiegu: "Cena zabiegu (zl/ha)", NazwaZabiegu: "Nazwa zabiegu", NumberZabiegu: "Numer zabiegu", Sezon: "2017", Zrodlo: "PaPu"},
		{Nazwa: "PaPu Nawozenie PROD", NazwaCenyZabiegu: "Cena zabiegu (zl/ha)", NazwaZabiegu: "Nazwa zabiegu", NumberZabiegu: "Numer zabiegu", Sezon: "2018", Zrodlo: "PaPu"},
		{Nazwa: "Siew PROD", NazwaCenyZabiegu: "Cena mieszanki (zl/ha)", NazwaZabiegu: "Mieszanina", NumberZabiegu: "Numer mieszanki", Sezon: "2018", Zrodlo: "Siew"},
		{Nazwa: "SoR Mieszaniny PROD", NazwaCenyZabiegu: "Cena mieszanki (zl/ha)", NazwaZabiegu: "Mieszanina", NumberZabiegu: "Numer mieszanki", Sezon: "2018", Zrodlo: "SoR"}
	]
...
function DodajWpisDoOplacalnoscUpraw(kosztyZabiegu,pole,StrukturaTabeli){
	for(var status in kosztyZabiegu.koszt_zl_ha){
		if(kosztyZabiegu.koszt_zl_ha[status]>=0){
			...
			nowyKosztZabiegow["Lista zabiegow"] = kosztyZabiegu.NazwaZabiegu;
